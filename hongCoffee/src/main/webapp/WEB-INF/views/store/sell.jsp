    ...
    <div class="container-fluid page-body-wrapper">
     ...
     <!--     include left -->
      ...
      <div class="main-panel">
		...
		<h2>판매 관리</h2><br>
		<div><h3 style="margin-top: 15px;">판매 검색</h3></div>
		
		<form action="${pageContext.request.contextPath}/store/sellSearch" class="sellSearch" method="post">
			<div id="search">
				<ul>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelector('.sellSearch').addEventListener('submit', function(event) {

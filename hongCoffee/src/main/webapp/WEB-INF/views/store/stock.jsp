  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
		...
		<button style="background-color: black; color: #EFBDBC;" onclick="window.open('${pageContext.request.contextPath}/stock/popup/stock_insert','홍커피','width=370,height=520')">추가</button>
		<button style="background-color: black; color: #EFBDBC;" onclick="window.open('${pageContext.request.contextPath}/stock/popup/stock_update','홍커피','width=370,height=520')">수정</button>
		</div>

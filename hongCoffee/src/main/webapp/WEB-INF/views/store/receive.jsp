...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/js/select.dataTables.min.css">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<form action="">
						<div id="search">
							<ul>
								<li><div class="search_div">
										<label class="search_name"><b>재료명</b></label> <input
											type="text">
									</div></li>

								<li><div class="search_div">
										<label class="search_name"><b>단가</b></label> <input
											type="text">
									</div></li>

								<li><div class="search_div">
										<label class="search_name"><b>입고일시</b></label> <input
											type="text"> <span class="button"><button
												type="button"
												style="background-color: black; color: #EFBDBC">조회</button></span>
									</div></li>
							</ul>
						</div>
					</form>
					...
					<div
						style="width: 50%; height: 50px; float: left; vertical-align: bottom !important;">
						<h3 style="margin-top: 15px;">재료 목록</h3>
					</div>
					<div
					...
					<!-- 		목록 -->
					<div
						style="width: 100%; height: 700px; border: black 1px solid; float: left; text-align: center;">
						<table class="table">
							...
							<c:forEach var="ReceiveDTO" items="${receiveList}">
								<tr>
									<td
										style="text-align: center !important; font-size: 20px !important;">${ReceiveDTO.od_num}</td>
									<td
										style="text-align: center !important; font-size: 20px !important;">${ReceiveDTO.item_name}</td>
									<td
										style="text-align: center !important; font-size: 20px !important;">${ReceiveDTO.rc_amount}</td>
									<td
										style="text-align: center !important; font-size: 20px !important;">${ReceiveDTO.item_price}</td>
									<td
										style="text-align: center !important; font-size: 20px !important;">${ReceiveDTO.rc_time}</td>
									<c:if test="${ReceiveDTO.pay eq 0}">
										<td
											style="text-align: center !important; font-size: 20px !important; color: red;">미결제</td>
									</c:if>
									<c:if test="${ReceiveDTO.pay eq 1}">
										<td
											style="text-align: center !important; font-size: 20px !important; color: red;">결제완료</td>
									</c:if>

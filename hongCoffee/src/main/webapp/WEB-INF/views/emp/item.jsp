...
<div class="nav-item dropdown">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
		...
		<input type="button" value="추가" name="store_insert" style="background-color: black; color: #EFBDBC;" onclick="window.open('${pageContext.request.contextPath}/emp/popup/item_insert','홍커피','width=460,height=520')"> 
		<input type="button" value="수정" name="store_update" style="background-color: black; color: #EFBDBC;" onclick="window.open('${pageContext.request.contextPath}/emp/popup/item_update?item_num=1','홍커피','width=460,height=520')">
		</div>

...
<div><b>사원번호</b></div><input type="text" name="emp_num" readonly><br>
<sub></sub>
...
<sub></sub>
<br>
<input type="submit" value="등록하기" style="float:right; margin-right: 50px; background-color: black; color: #EFBDBC;">
</fieldset>
</form>

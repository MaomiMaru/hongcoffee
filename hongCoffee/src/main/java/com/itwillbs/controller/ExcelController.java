...
public class ExcelController {
	...
	public void orderList(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
	...
	public void shipmentList(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
